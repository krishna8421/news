      ...
      <HomePageLayout>
        <div className="mt-16">
          <div className="drawer">
            <button
              className={val == 1 ? "drawerBtnActive" : "drawerBtn"}
              onClick={() => setVal(1)}
            >
            ...
            {isEditor && (
              <>
                <button
                  className={val == 2 ? "drawerBtnActive" : "drawerBtn"}
                  onClick={() => setVal(2)}
                >
                  <span className="p-[5px] sm:mr-4 bg-white rounded-full">
                ...
                <button
                  className={val == 3 ? "drawerBtnActive" : "drawerBtn"}
                  onClick={() => setVal(3)}
                >
                  <span className="p-[5px] sm:mr-4 bg-white rounded-full">
                    <MdDrafts color="red" />
                ...
                <button
                  className={val == 4 ? "drawerBtnActive" : "drawerBtn"}
                  onClick={() => setVal(4)}
                >
                ...
                <button
                  className={val == 5 ? "drawerBtnActive" : "drawerBtn"}
                  onClick={() => setVal(5)}
                >
                  <span className="drawerBtnIcon">
